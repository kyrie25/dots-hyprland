...
wallpaperenginepkg=./sdata/dist-arch/illogical-impulse-linux-wallpaperengine-git
v git submodule update --init --recursive -- "$wallpaperenginepkg/linux-wallpaperengine"

metapkgs=("$wallpaperenginepkg")
