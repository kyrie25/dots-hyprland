...
Singleton {
    ...
    property string wallpaperEngineScriptPath: FileUtils.trimFileProtocol(`${Directories.scriptPath}/wallpaperEngine/wallpaper-engine.py`)
    property string wallpaperRuntimeScriptPath: FileUtils.trimFileProtocol(`${Directories.scriptPath}/wallpaperEngine/runtime.sh`)
